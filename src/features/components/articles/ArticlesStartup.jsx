            ...
            <section className={`${styles.container} d-flex`}>
                ...
                >
                    ...
                    <p className={`${styles.article_title}`}>
                        Azərbaycanın startap ekosisteminin çətinliyi
                        hansılardır?
                    </p>
                    <section className={`${styles.article_paragraph}`}>
                        <p>
                            1997-ci ildə bir DVD kirayə mağaza kimi işə başlayan
                            Netflix, 2020-ci ilin sonundan etibarən, 190-dan çox
                            ölkədə fəaliyyət göstərərkən 204 milyon istifadəçisi
                            və 25 milyard ABŞ dolları gəliri olan ən böyük
                            subscription-əsaslı kontent izləmə oyunçusudur.
                            Şirkətin bu müddətə qədərki inkişaf strategiyasını 4
                            mərhələyə bölmək olar.
                        </p>
                        <p className={`${styles.paragraph_title}`}>
                            TWC-də biz inanırıq ki, startap yaratmaq ən çətin,
                            ancaq qurucuların karyeralarında özlərindən daha
                            böyük bir şey yarada biləcəkləri ən vacib
                            təşəbbüsdür.
                        </p>
                    </section>
                    <img
                    ...
                    <section className={`${styles.article_paragraph}`}>
                        ...
                        <p>
                            Qlobal bazarlarda startaplara olan marağın dollar
                            baxımından trendi son illərlə müqayisədə hazırda hər
                            dörd startap böyümə mərhələsi üçün rekord həddədir.
                            Ancaq TWC-yə görə Azərbaycanın startap ekosistemi üç
                            səbəbə əsasən qlobal tempi tutmaqdan bir xeyli
                            uzaqdır, baxmayaraq ki, son onillikdə startaplara
                            olan maraq həm sahibkarlarda, həm də
                            istiqamətlənməsi mükəmməlikdən uzaq olan dövlət
                            institutlarında yaranmışdır.
                            <ul className={`${styles.list_group}`}>
                                <li>
                                    Birincisi, sahibkarlar tərəfindən sürətli
                                    MVP-lərin və sürətli feedback loopların
                                    yaradıla bilinməməsidir.
                                </li>
                                <li>
                                    İkincisi, yerli investorlara keçidin limitli
                                    olması.
                                </li>
                                <li>
                                    Üçüncü, dövlət institutları tərəfindən açıq
                                    olan maliyyələşmə kriteriyalarının sərt və
                        ...
                        <p>
                            TWC-nin peşəkar və startap təcrübəsi olan biznes
                            konsultantlarının həm yerli həm də xarici bazarlarda
                            startaplara fərqli böyümə mərhələlərində dəstəyi
                            var. Əməliyyat tərəfdən, buna ideyanın
                            qiymətlədirilməsi, MVP-nin yaradılması, ilk
                            istifadəçilərin cəlb edilməsi, maliyyələşməyə
                            hazırlanma, PMF-ə çatma və online & offline
                            auditoriyanın qurulması daxildir. Maliyyələşmə
                            tərəfdən, buna pre-seed, seed, Stage A, Stage A+ və
                            Exit (VC, PE, Strateji Alıcı və IPO) maliyyələşməsi
                            daxildir.
                        </p>
                        <p>
                            TWC-də bizim şüarımız qeyri-müəyyənliyi
                            qucaqlamaqdır.
                        </p>
                    </section>
