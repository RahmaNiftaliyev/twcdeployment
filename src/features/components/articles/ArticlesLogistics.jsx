            ...
            <section className={`${ styles.container } d-flex`}>
                ...
                >
                    ...
                    <section className={`${ styles.article_paragraph }`}>
                        <p>
                            Komandamızın apardığı ilkin araşdırmalara görə, Azərbaycanda hava yükdaşıma şirkətlərini seçərkən qiymət, qəbul məntəqələri və sürət aparıcı amillərdir.
                        </p>
                        <p>

                            Sənayedə nəzərə çarpacaq dərəcədə gərgin rəqabət aparıcı firmaları bazar payını artırmaq üçün yeni bir dəyər təklifi formalaşdırmağı tələb edir.
                        </p>

                        <p>

                            Hal-hazırda təqribən 55 hava yükdaşıma şirkəti mövcuddur. Bununla belə, onların əksəriyyəti eyni dəyər təklifləri üzərində rəqabət aparır. 1A rəqabət meyarları:
                        </p>
                    </section>
                    <img
                        src={sectionImgPng}
                    ...
                    />
                    <section className={`${ styles.article_paragraph }`}>
                            <p>Qrafikdən də göründüyü kimi, firmaların əksəriyyəti 
                            dıyır təklifini bəyannamə doldurulma və konkret hədəf qruplarına 
                            müxtəlif tanıtım kampaniyaları təklif etməklə həyata keçirir. Karqo 
                            firmalarının əldə etməyə çalışdıqları digər mühüm amillər bölgələr daxilində 
                            qəbul məntəqələrinin sayını artırmaqdır.</p>

                            <p>Bununla belə, bizim mövzu ilə bağlı ilkin və ikinci 
                            dərəcəli araşdırmalarımız Azərbaycanda yükdaşıma sənayesinin 
                            gələcəyinin firmaların öz müştərilərinə daha çox fərdiləşdirilmiş 
                            təkliflər həyata keçirəcəyini proqnozlaşdırır. Daha dəqiq desək, 
                            müştərilərinizi digərlərindən daha yaxşı tanımaq vaxtı artıq yetişib!</p>


                            <p>Böyük onlayn B2C platformaları artıq bu strategiyanı
                             qəbul ediblər. Məsələn, Amazon, Facebook və YouTube 
                             istifadəçilərinin nə istədiklərini onların özlərindən 
                             daha yaxşı bilir.</p>
                    </section>
                            <p className={`${styles.article_features_desc}`}>
                                    “Yüksək rəqabət və müştərilərin fərqlənən tələbləri  Azərbaycandakı hava yükdaşıma
                                    şirkətlərini daha çox fərdiləşdirilmiş kampaniyalar təklif etmək üçün öz müştərilərinin 
                                    məlumat bazasını toplayıb kateqoriyalaşdırmağın əhəmiyyətini artıracaq.”
                             </p>
                    <section
